...
DEPENDENCY_CATALOG: dict[str, DependencyDefinition] = {
    "cumesh": DependencyDefinition(
        ...
        notes="Geometry remeshing/export dependency.",
    ),
    "o_voxel": DependencyDefinition(
        ...
        runtime_critical_for=("generate", "refine"),
        notes="Sparse voxel/native geometry dependency.",
    ),
    "spconv": DependencyDefinition(
        ...
        runtime_critical_for=("generate", "refine"),
        notes="Generate path depends on sparse-conv support; CUDA wheel naming varies by torch/CUDA build.",
    ),
    "cumm": DependencyDefinition(
        ...
        runtime_critical_for=("generate", "refine"),
        notes="Low-level sparse-conv dependency paired with spconv; CUDA wheel naming varies by torch/CUDA build.",
    ),
